...
from lib.utils.base import convert_to_rgb, compute_homography_discrete, round_coordinates, random_crop, \
    draw_corspd, draw_kps, draw_corspd_region, resize_max_length, compute_scale, compute_local_contrast, \
    compute_scale_xy, draw_scale, get_homography_correspondence


class HpatchesV2(Dataset):
